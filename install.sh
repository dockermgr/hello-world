...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210121114-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 12, 2022 11:14 EDT
# @@File             :  install.sh
# @@Description      :  
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/hello-world"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="hello-world"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/hello-world"
APPDIR="$HOME/.local/share/srv/docker/hello-world"
DATADIR="$HOME/.local/share/srv/docker/hello-world/files"
...
HUB_IMAGE_URL="casjaysdevdocker/hello-world"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
